...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Part 3 muP LR sweep on the smallest model.")
    parser.add_argument("--config", default="configs/mup_sweep_lr.yaml", help="Path to muP sweep yaml.")
...
def main() -> None:
    ...
    output_dir = Path(sweep_cfg.get("output_dir", "outputs/part3_mup_lr_sweep"))
    ...
    for lr in learning_rates:
        ...
        print(f"[mup-sweep] lr={lr} run={cfg['run']['name']}")
